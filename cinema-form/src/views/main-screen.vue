    ...
    return {
      ...
      films: [
        ...
        },
        {
          ...
          img: require("../assets/img/fast-and-furious.png"),
        ...
        {
          title: "Заклятие 2",
          img: require("../assets/img/conjuring-2.png"),
          genre: ["Ужасы", "Триллер"],
        ...
        {
          title: "Терминатор",
          img: require("../assets/img/terminator.png"),
        ...
        {
          title: "1+1",
          img: require("../assets/img/one-plus-one.png"),
          genre: ["Драма", "Комедия"],
        ...
        },
        {
          ...
          img: require("../assets/img/ivan-vasilevich.png"),
        ...
        {
          title: "Король лев",
          img: require("../assets/img/lion-king.png"),
        ...
        },
        {
          ...
          img: require("../assets/img/pulp-fiction.png"),
